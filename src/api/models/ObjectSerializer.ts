...
import { DeleteSurveyResponse } from './DeleteSurveyResponse';
import { Driver } from './Driver';
import { DriverDetails } from './DriverDetails';
import { Factor } from './Factor';
import { FactorDetails } from './FactorDetails';
import { GetByIdPostResponse } from './GetByIdPostResponse';
import { GetSurveyByIdResponse } from './GetSurveyByIdResponse';
import { HealthInfoResponse } from './HealthInfoResponse';
import { ListPostsResponse } from './ListPostsResponse';
import { ListSurveysResponse } from './ListSurveysResponse';
import { NewPostRequest } from './NewPostRequest';
import { NewSurveyRequest } from './NewSurveyRequest';
import { PostDto } from './PostDto';
import { PostSummaryDto } from './PostSummaryDto';
import { PublicAuthSettingsDto } from './PublicAuthSettingsDto';
...
import { UpdatePostResponse } from './UpdatePostResponse';
import { UpdateSurveyRequest } from './UpdateSurveyRequest';
import { UpdateSurveyResponse } from './UpdateSurveyResponse';
...
let typeMap: {[index: string]: any} = {
    ...
    "GetByIdPostResponse": GetByIdPostResponse,
    "GetSurveyByIdResponse": GetSurveyByIdResponse,
    ...
    "PublicAuthSettingsDto": PublicAuthSettingsDto,
    "Question": Question,
